...
import { User, Settings, LogOut, History, X } from "lucide-react"
...
export function StudentSidebar({ isOpen, onClose, userData }: StudentSidebarProps) {
  const handleLogout = () => {
    logout()
  }
        ...
        <div className="p-6">
          ...
          <div className="flex items-center gap-3 mb-8 p-4 bg-green-50 rounded-lg">
            ...
            <div>
              ...
              <p className="text-sm text-green-600">Grade {userData.grade}</p>
              <p className="text-xs text-green-500 capitalize">{userData.difficulty} Level</p>
            </div>
          </div>
